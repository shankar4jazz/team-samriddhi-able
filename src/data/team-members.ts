...
export const teamMembers: TeamMember[] = [
  {
    ...
    description: "Meet Vikas B C, Associate Financial Planner at Wealth Builders - Investment Service, based in Harapanahalli. With a record-breaking 86 units of blood collected in a donation camp—Vikas has made history in his town! A true believer in the mantra Learn, Unlearn, Relearn, Repeat, he respects others' time and invests his own in learning new things.",
    family: "Living with his inspiring mother, a Tax Practitioner for 26 years",
    specialization: ["Wealth Management", "Investment Services", "Financial Planning"],
    achievements: ["Record-breaking 86 units of blood collected in donation camp"],
    interests: ["Learning new things", "Social service"]
  },
  {
    id: "ramakrishna",
